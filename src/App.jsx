...
const allProducts = [
    { id: 1, country: 'Estados Unidos', price: '259', promo: null, type: 'USA', category: 'eSIM', features: ['Plano com Internet Ilimitada', 'Plano Controle com 10Gb ou 20Gb', 'Velocidade 5G/4G', 'Mantenha seu número de WhatsApp'] },
    { id: 2, country: 'Europa', price: '329', promo: null, type: 'EUROPE', category: 'eSIM', features: ['Plano com Internet Ilimitada', 'Plano Controle com 10Gb ou 20Gb', 'Cobertura em 28 Países', 'Mantenha seu número de WhatsApp'] },
    { id: 9, country: 'Ásia', price: '289', promo: null, type: 'ASIA', category: 'eSIM', features: ['Plano com Internet Ilimitada', 'Plano Controle com 10Gb ou 20Gb', 'Velocidade 5G/4G', 'Mantenha seu número de WhatsApp'] },
    { id: 4, country: 'Mundo', price: '349', promo: null, type: 'WORLD', category: 'eSIM', features: ['Plano com Internet Ilimitada', 'Plano Controle com 10Gb ou 20Gb', 'Cobertura em 200+ destinos', 'Ideal para múltiplos países'] },
    { id: 3, country: 'América do Sul', price: '289', promo: null, type: 'SA', category: 'eSIM', features: ['Plano com Internet Ilimitada', 'Cobertura em 8 Países', 'Velocidade 5G/4G', 'Mantenha seu número de WhatsApp'] },
    { id: 11, country: 'América do Norte', price: '289', promo: null, type: 'NA', category: 'eSIM', features: ['Plano Controle com 10Gb', 'Cobertura em 3 Países', 'Velocidade 5G/4G', 'Mantenha seu número de WhatsApp'] },
    { id: 5, country: 'Estados Unidos', price: '299', promo: null, type: 'USA', category: 'Chip Físico', features: ['Internet Ilimitada', 'Velocidade 5G/4G', 'Receba o Chip em casa', 'Mantenha seu número de WhatsApp'] },
    { id: 6, country: 'Europa', price: '369', promo: null, type: 'EUROPE', category: 'Chip Físico', features: ['Internet Ilimitada', 'Cobertura em 42 países', 'Velocidade 5G/4G', 'Mantenha seu número de WhatsApp'] },
    { id: 10, country: 'Ásia', price: '319', promo: null, type: 'ASIA', category: 'Chip Físico', features: ['Internet Ilimitada', 'Cobertura em 18 países', 'Velocidade 5G/4G', 'Mantenha seu número de WhatsApp'] },
    { id: 8, country: 'Mundo', price: '399', promo: null, type: 'WORLD', category: 'Chip Físico', features: ['Internet Ilimitada', 'Cobertura em 200+ destinos', 'Velocidade 5G/4G', 'Mantenha seu número de WhatsApp'] },
    { id: 7, country: 'América do Sul', price: '319', promo: null, type: 'SA', category: 'Chip Físico', features: ['Internet Ilimitada', 'Cobertura em 8 países', 'Velocidade 5G/4G', 'Mantenha seu número de WhatsApp'] }
];
...
const faqItems = [
    ...
    { q: "Em quanto tempo recebo o chip ou o eSIM após a compra?", a: "O prazo de entrega varia conforme sua localidade. Chips físicos são entregues gratuitamente em até 7 dias úteis. Se a sua viagem estiver próxima, entre em contato conosco para mais opções de entrega.\nO eSIM é enviado por Whatsapp em até 2 horas após a compra." },
    ...
    { q: "Posso manter meu número brasileiro no Whatsapp enquanto uso o chip internacional?", a: "Sim, seu número de Whatsapp não muda. Você pode utilizar o WhatsApp normalmente para enviar mensagens, fazer chamada de vídeos e ligações." },
            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="bg-white rounded-[32px] p-8 md:p-12 border border-slate-100 shadow-xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-12">
                        <div className="bg-[#F9F5FF] p-8 rounded-[24px] border border-[#E0D4FF] flex flex-col">
                            ...
                            <p className="text-slate-600 font-medium text-justify mb-6 flex-grow">Digite <strong className="text-[#1A2B6D]">*#06#</strong> no discador de seu celular. Se aparecer o código <strong className="text-[#1A2B6D]">EID</strong>, o celular é compatível com eSIM.</p>
                            <a href="https://wa.me/13213104764" target="_blank" rel="noopener noreferrer" className="mt-auto flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1DA851] text-white font-bold py-3 px-4 rounded-xl transition-all text-sm text-center shadow-md">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51a12.8 12.8 0 0 0-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z"/></svg> Com Dúvidas? Fale Conosco no WhatsApp
                            </a>
                        </div>
                    ...
                    <div className="prose prose-slate max-w-none prose-headings:text-[#1A2B6D] prose-headings:font-black prose-p:font-medium prose-p:text-slate-500 prose-li:font-medium prose-li:text-slate-600">
                        ...
                        <p className="text-sm text-amber-600 bg-amber-50 p-4 rounded-xl mb-8 font-bold border border-amber-100">* Recomendamos que verifique através de um dos métodos acima para garantir a compatibilidade.</p>
...
export default function App() {
    ...
    return (
        <div className="min-h-screen font-sans text-[#1A2B6D]" style={{ backgroundColor: '#F9F5FF' }}>
                    ...
                    <section className="py-24 bg-[#F9F5FF] text-center">
                        <div className="max-w-4xl mx-auto px-6">
                            ...
                            <div className="grid gap-3 text-left">
                                {(showAllFaqs ? faqItems : faqItems.slice(0, 8)).map((f, i) => (
                                    <div key={i} onClick={() => setOpenFaq(openFaq === i ? null : i)} className={`bg-white p-5 rounded-2xl border transition-all cursor-pointer shadow-sm ${openFaq === i ? 'border-[#A64DFF]' : 'border-[#E0D4FF] hover:border-[#A64DFF] group'}`}>
                                        ...
                                        {openFaq === i && (
                                            <div className="mt-4 text-slate-500 font-medium leading-relaxed animate-in slide-in-from-top-2 whitespace-pre-line">
                                                {f.a}
                                            </div>
                                        )}
                                    </div>
                            ...
                            <div className="mt-16 p-10 bg-white rounded-[40px] border border-[#E0D4FF] shadow-xl flex flex-col items-center gap-6">
                                ...
                                <a href="https://wa.me/13213104764" target="_blank" rel="noopener noreferrer" className="bg-[#25D366] hover:bg-[#128C7E] text-white px-10 py-4 rounded-2xl font-black text-lg flex items-center gap-3 shadow-lg transition-all hover:scale-105 active:scale-95"><svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51a12.8 12.8 0 0 0-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z"/></svg> Fale Conosco</a>
                            </div>
                        </div>
                    </section>
            ...
            {/* RODAPÉ */}
            <footer className="bg-[#1A2B6D] text-slate-400 py-10 mt-auto">
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8 text-center md:text-left">
                    <div className="flex flex-col items-center md:items-start text-center md:text-left">
                        <div className="mb-1"><LogoComponent setView={setView} /></div>
